...
// vision_msgs
#include <vision_msgs/sign_detection_msg.h>
#include <vision_msgs/sign_array_msg.h>
...
#include <darknet_ros/keras_model.h>
#include <fstream>
#include <algorithm>
#include <math.h>
...
class YoloObjectDetector {
 public:
   ...
   * Constructor.
   */
  explicit YoloObjectDetector(ros::NodeHandle nh, keras::KerasModel *km);
 ...
 private:
  ...
  vision_msgs::sign_array_msg bboxs;
